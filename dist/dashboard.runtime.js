...
DesignLang.spring('.dl-cta-button', { stiffness: 250, damping: 25, mass: 0.008 });




DesignLang.haptic('.dl-cta-button', { force: 20 });
DesignLang.audio('.dl-cta-button', { hover: 660 });
...
DesignLang.cursor('.dl-material-demo');
...
DesignLang.tooltip('.dl-accent-demo');